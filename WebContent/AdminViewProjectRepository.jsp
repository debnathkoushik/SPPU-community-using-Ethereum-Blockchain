			...
			<div class="container">
				...
				<li><b>Welcome Admin</b></li>
					...
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li  class="active"><a href="AdminProjectRepository.jsp"><b>Projects Repository</b></a></li>
                    ...
                    <th>Branch</th>
                     ...
                     <th>Action</th>
							...
							Statement st=con.createStatement();
							 ResultSet rs=st.executeQuery("select * from projects_data where branch='"+branch+"' and domain='"+domain+"' ");
