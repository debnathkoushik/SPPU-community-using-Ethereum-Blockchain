				 ...
				 HttpSession sessio=request.getSession(true);  
	               ...
	               String name=(String)session.getAttribute("student");  
					...
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li class="active"><a href="CheckProjectStatus.jsp"><b>Check Status</b></a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-lg-12">
							...
							<h2><b>Check Project Status</b></h2>
						<br><br><br><br>
							</div>
						</div>
						<div class="col-sm-offset-4 col-lg-6 ">
							<form class="inline" id="contactForm" action="CheckStatusController" method="post">
								<div class="row">
