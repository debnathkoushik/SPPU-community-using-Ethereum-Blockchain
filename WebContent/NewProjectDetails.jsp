		...
		<div class="container">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right custom-menu">
					...
					<li><a href="ProjectRepository.jsp"><b>Projects
								Repository</b></a></li>
					<li><a href="VerifyTitle.jsp"><b>Verify Title</b></a></li>
					<li class="active"><a href="NewProjectDetails.jsp"><b>New
								Project</b></a></li>
				...
				<div class="col-md-12">
					...
					<div class="col-sm-offset-4 col-lg-6 ">
						<form class="inline" id="contactForm"
							action="NewProjectDetailsController" method="post"
							...
							<div class="row">
								...
								<div class="col-sm-8 height-contact-element">
									<div class="form-group">
										<select type="text" name="guide"
											class="form-control custom-labels" id="name"
											placeholder="Branch">
											<option style="background-color: black">Select Guide
												Preferences</option>
											<%
											...
											<option style="background: blue"
												value="<%=list.get(i).getName()%>"><%=list.get(i).getName()%></option>
								...
								<div class="col-sm-8 height-contact-element">
									<div class="form-group">
										<select type="text" name="branch"
											class="form-control custom-labels" id="name"
											placeholder="Branch">
											<option style="background-color: black">Select
												Branch</option>
											...
											<option style="background-color: black">IT</option>
								...
								<div class="col-sm-8 height-contact-element">
									<div class="form-group">
										<select type="text" name="domain"
											class="form-control custom-labels" id="name"
											placeholder="Domain">
											<option style="background-color: black">Select
												Domain</option>
											<option style="background-color: black">Cloud
												Computing</option>
											<option style="background-color: black">Data Mining</option>
											<option style="background-color: black">Networking</option>
											<option style="background-color: black">Image
												Processing</option>
											<option style="background-color: black">Heat Transfer</option>
											<option style="background-color: black">Design</option>
											<option style="background-color: black">Automobile</option>
											<option style="background-color: black">Refrigeration</option>
											<option style="background-color: black">Air Conditioning</option>
											<option style="background-color: black">Vibration</option>
											<option style="background-color: black">Embedded</option>
											<option style="background-color: black">VLSI</option>
											<option style="background-color: black">Aurdino</option>
								...
								<div class="col-sm-8 height-contact-element">
									<div class="form-group">
										<label>Enter Project Abstract</label>
