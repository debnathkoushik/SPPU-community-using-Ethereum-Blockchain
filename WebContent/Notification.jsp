				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-sm-offset-4 col-lg-6 ">
							<form  id="contactForm" action="StaffForgotPassController" method="post" >
								<!-- <div class="row">
									...
									<div class="col-sm-offset-4 col-xs-4 ">
											...
											<a href="StudentNotification.jsp" class="btn btn-md btn-custom btn-noborder-radius"style="color:black" ><b>For Student</b></a><br><br><br><br>
											<a href="StaffNotification.jsp" class="btn btn-md btn-custom btn-noborder-radius"style="color:black" ><b>For Staff</b></a>
