				 ...
				 HttpSession sessio=request.getSession(true);  
	               ...
	               String name=(String)session.getAttribute("student");  
					...
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li  class="active"><a href="ProjectRepository.jsp"><b>Projects Repository</b></a></li>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-sm-offset-4 col-lg-6 ">
							<form class="inline" id="contactForm" action="ViewProjectRepository.jsp" method="post" >
								<div class="row">
