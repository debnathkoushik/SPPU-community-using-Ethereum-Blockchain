				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-lg-12">
							...
							<p>If you have registered user <a href="StudentLogin.jsp"> click Here ?</a></p>
							</div>
						</div>
						<div class="col-sm-offset-4 col-lg-6 ">
							<form class="inline" id="contactForm" action="StudentRegisterController" method="post" >
								<div class="row">
									...
									<div class="col-sm-8 height-contact-element">
										<div class="form-group">
											<input type="text" name="email" class="form-control custom-labels"   title="Enter your email (abc@gmail.com)" placeholder="Email" />
										</div>
									</div>
									...
									<div class="col-sm-8 height-contact-element">
										<div class="form-group">
											<select type="text" name="year" class="form-control custom-labels" placeholder="Year">
											<option style="background-color: black">Select Year</option>
											<option style="background-color: black">First Year</option>
											<option style="background-color: black">Second Year</option>
											<option style="background-color: black">Third Year</option>
											<option style="background-color: black">Final Year</option>
											</select>
										</div>
									</div>
									...
									<div class="col-sm-8 height-contact-element">
										<div class="form-group">
											<input type="text" name="prnno" class="form-control custom-labels"  title="Enter 8 digit and 1 Capital alphabet (eg.71540778G)" placeholder="PRN Number" />
										</div>
									</div>
