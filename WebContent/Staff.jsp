			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li class="active"><a href="Staff.jsp"><b>University Staff</b></a></li>	
					</ul>
				</div>
			</div>
		</nav>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-lg-12">
							...
							<h2><b>University Staff Login</b></h2>
							<br>
							<p>If you have new user <a href="RegisterStaff.jsp" style="color:red"> click Here ?</a></p>
							</div>
						</div>
						<div class="col-sm-offset-4 col-lg-6 ">
							<form class="inline" id="contactForm" action="StaffLoginController" method="post" >
								<div class="row">
									...
									<a href="ForgotPass.jsp" style="color:red">Forgot Password ?</a>
