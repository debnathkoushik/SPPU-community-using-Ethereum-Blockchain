				 ...
				 HttpSession sessio=request.getSession(true);  
	               ...
	               String name=(String)session.getAttribute("staff");  
					...
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li class="active"><a href="StudStaffNotification.jsp"><b>Send Notification</b></a></li>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-sm-offset-4 col-lg-6 ">
							<form  id="contactForm" action="StaffStudentNotificationController" method="post" >
								 <div class="row">
								
									<div class="col-sm-8 height-contact-element">
									
									<div class="form-group">
											<input  name="groupno" class="form-control custom-labels" id="name" Placeholder="Enter Group Number">
											
										</div> 
										<div class="form-group">
											<textarea  name="student" class="form-control custom-labels" id="name">
											</textarea>
										</div> 
