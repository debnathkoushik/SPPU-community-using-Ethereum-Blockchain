				 ...
				 HttpSession sessio=request.getSession(true);  
	               ...
	               String name=(String)session.getAttribute("student");  
					...
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li  class="active"><a href="VerifyTitle.jsp"><b>Verify Title</b></a></li>
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="col-sm-offset-4 col-lg-6 ">
							<form class="inline" id="contactForm" action="VerifyTitleController" method="post" >
								<div class="row">
									...
									<div class="col-sm-8 height-contact-element">
										<div class="form-group">
											<input type="text" name="title" class="form-control custom-labels" id="name" placeholder="Enter Project Title"/>
									...
									<div class="col-sm-8 height-contact-element">
										...
										<label>Enter Project Abstract</label>
											<textarea type="text" name="abstract" class="form-control custom-labels" id="name" placeholder="Enter Project Title">
											</textarea>
										</div>
									</div>
