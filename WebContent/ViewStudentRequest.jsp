				 ...
				 HttpSession sessio=request.getSession(true);  
	               ...
	               String name=(String)session.getAttribute("staff");  
					...
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li class="active"><a href="ViewStudentRequest.jsp"><b>View Student Requests</b></a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-lg-12">
							<div class="text-center color-elements">
								<br><br><br>
							<h2><b>View Student Requests</b></h2>
						<br><br>
							</div>
						</div>
                    ...
                    <th>Action</th>
							...
							Statement st=con.createStatement();
							 ResultSet rs=st.executeQuery("select * from Projects_data where guide='"+name+"'");
				          ...
				          while(rs.next())
		                     {
		                    	...
		                    	<td><a style="color:red"
									href="StudentsStatusController?groupno=<%=rs.getString(1)%>&guide_status=<%=rs.getString(10)%>"><%=rs.getString(10)%></a></td>
		                    	 </TR>
