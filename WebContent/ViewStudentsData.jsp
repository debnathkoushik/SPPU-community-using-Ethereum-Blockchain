			...
			<div class="container">
				...
				<li><b>Welcome Admin</b></li>
					...
					<ul class="nav navbar-nav navbar-right custom-menu">
						...
						<li  class="active"><a href="ViewStudentsData.jsp"><b>View Student Data</b></a></li>
				          ...
				          while(rs.next())
		                     {
		                    	 ...
		                    	 <td><a style="color:red" href="StudentDeleteController?id=<%=rs.getString(1)%>">Delete</a></td>
		                    	 </TR>
